import type { FlowMapLayerFeature, PointMapFeature } from "@moritzbrantner/maps";

import type { HistoricalSource } from "../model/sourceTypes";

export type HistoricalSourceFeature = PointMapFeature<HistoricalSource["properties"]>;
...
export type SourceReferenceFlowFeature = FlowMapLayerFeature<SourceReferenceFlowProperties>;
...
export function createSourceReferenceFlows(source: HistoricalSource): SourceReferenceFlow[] {
  return [
