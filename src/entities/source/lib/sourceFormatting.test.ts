...
import { formatTimelineYear, getTimelineLabel, getTimelineYear } from "./sourceFormatting";
...
describe("sourceFormatting", () => {
  ...
  it("gets labels for the requested timeline mode", () => {
    ...
    expect(getTimelineLabel(source, "source")).toBe("3rd century BC-1st century AD");
  });
});
