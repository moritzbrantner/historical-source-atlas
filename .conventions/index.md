...
- **NEXT-001 — Prefer the donut pattern** — Keep the tree server-rendered by default; add focused client boundaries only for interactive behavior. ([details](modules/nextjs/technologies/typescript/react/nextjs/README.md))
- **NEXT-002 — Keep page-specific code local** — Keep code used by one route in its local scope; move it only when real reuse broadens ownership. ([details](modules/nextjs/technologies/typescript/react/nextjs/README.md))
...
- **RHF-001 — Use React Hook Form for non-trivial forms** — Use React Hook Form for meaningful validation, related or dynamic fields, submission state, or reusable form logic. ([details](modules/react-hook-form/technologies/typescript/react/react-hook-form/README.md))
...
- [modules/nextjs/technologies/typescript/react/nextjs/README.md](modules/nextjs/technologies/typescript/react/nextjs/README.md)
...
- [modules/react-hook-form/technologies/typescript/react/react-hook-form/README.md](modules/react-hook-form/technologies/typescript/react/react-hook-form/README.md)
