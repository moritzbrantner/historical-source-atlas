...
const excludedPaths = [
  ...
  'app/[locale]/(public)/report-problem',
  'app/[locale]/(public)/reset-password',
  'app/[locale]/(public)/verify-email',
  'app/[locale]/atlas/collections',
];
const scannedRoutePaths = [
  '',
  '/atlas',
  '/atlas/about',
  '/atlas/sources/dead-sea-scrolls',
  '/atlas/persons/teacher-of-righteousness',
  '/atlas/locations/dead-sea-scrolls-place',
  '/atlas/events/dead-sea-scrolls-discovery',
  '/about',
  '/blog',
  '/changelog',
  '/examples/forms',
...
const scannedRoutes = ['en', 'de'].flatMap((locale) =>
  scannedRoutePaths.map((route) => `${githubPagesBasePath}/${locale}${route}`),
);
const mimeTypes = {
